...
train_pipeline = [
    ...
    dict(type='ObjectCenters', sigma=3.0, normalize=True),
    dict(type='DefaultFormatBundle', img_to_float=True),
    dict(
        type='Collect',
        keys=['img', 'gt_bboxes', 'gt_labels', 'gt_masks', 'gt_semantic_seg', 'gt_centers']),
]
val_pipeline = [
...
data = dict(
    ...
    val=dict(pipeline=val_pipeline,test_mode=False,filter_empty_gt=False),
